...
from nemoguardrails.actions.actions import ActionResult, RailsConfig
...
async def rag(context: Dict, llm: LLMRails):
    ...
    try:
        ...
        return ActionResult(
            return_value=answer,  # The answer generated by the LLM
            context_updates=context_updates  # The context updates for hallucination checking
        )
